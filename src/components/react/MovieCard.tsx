      ...
      <div className='relative'>
        {!watched ? (
          <button
            ...
            className='absolute top-1 text-sm left-1 bg-blue-800 p-2 rounded-md hover:bg-blue-600 transition-all ease-in-out duration-300 cursor-pointer'
          >
            <svg
          ...
          <button
            ...
            className='absolute top-1 text-sm left-1 bg-red-800 p-2 rounded-md hover:bg-red-600 transition-all ease-in-out duration-300 cursor-pointer'
          >
            <svg
              xmlns='http://www.w3.org/2000/svg'
              viewBox='0 0 24 24'
