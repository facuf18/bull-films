...
export default function MovieCard({ movie }: MovieCardProps) {
  ...
  return (
    <div className='col-span-1 w-auto rounded-sm flex flex-col items-center gap-2 '>
      <Suspense fallback={'Loading...'}>
        <div className='relative'>
          {!watched ? (
            <button className='absolute top-1 text-sm left-1 bg-blue-800 p-2 rounded-md hover:bg-blue-600 transition-all ease-in-out duration-300 cursor-pointer'>
              <svg
            ...
            <button className='absolute top-1 text-sm left-1 bg-red-800 p-2 rounded-md hover:bg-red-600 transition-all ease-in-out duration-300 cursor-pointer'>
              <svg
                xmlns='http://www.w3.org/2000/svg'
                viewBox='0 0 24 24'
                fill='currentColor'
          ...
          {!isOnWatchlist ? (
            <button
              ...
              className='absolute top-1 text-sm right-1 bg-green-800 p-2 rounded-md hover:bg-green-600 transition-all ease-in-out duration-300 cursor-pointer'
            >
              Add to watchlist
            </button>
          ) : (
            <button
              ...
              className='absolute top-1 text-sm right-1 bg-red-800 p-2 rounded-md hover:bg-red-600 transition-all ease-in-out duration-300 cursor-pointer'
            >
              Remove
            </button>
          )}
